...
public class EocOnlineStatus extends HttpServlet {

	public EocOnlineStatus() {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		EocOnlineStatusReturnMessage msg = new EocOnlineStatusReturnMessage();
		EocOnlineStatusReturnMessageDetail msgdetail = new EocOnlineStatusReturnMessageDetail();
		msgdetail.setEocmac("00:00:00:00:00:00");
		msgdetail.setEocstatus("正常");
